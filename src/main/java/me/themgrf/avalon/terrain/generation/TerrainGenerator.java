...
public abstract class TerrainGenerator {
    ...
    public TerrainGenerator(PerlinNoiseGenerator perlinNoise, ColourGenerator colourGen) {
     ...
     */
    public LowPolyTerrain generateTerrain(int gridSize) {
        float[][] heights = generateHeights(gridSize, perlinNoise);
        RGB[][] colours = colourGen.generateColours(heights, perlinNoise.getAmplitude());
     ...
     */
    protected abstract LowPolyTerrain createTerrain(float[][] heights, RGB[][] colours);
